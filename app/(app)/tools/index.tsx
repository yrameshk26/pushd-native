...
const TOOLS = [
  { label: '1RM Calculator', sub: 'Estimate your one-rep max', icon: 'calculator-outline', route: '/(app)/tools/1rm' },
  { label: 'Plate Calculator', sub: 'Figure out your plate setup', icon: 'barbell-outline', route: '/(app)/tools/plates' },
  { label: 'AI Coach', sub: 'Chat with your fitness coach', icon: 'chatbubble-ellipses-outline', route: '/(app)/coach' },
  { label: 'AI Planner', sub: 'Generate a personalised program', icon: 'sparkles-outline', route: '/(app)/ai-planner' },
];
